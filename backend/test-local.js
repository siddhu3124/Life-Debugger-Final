...
const testLocal = async () => {
    try {
        ...
        console.log("Logged in locally! Token:", token ? "Received" : "None");

        console.log("Analyzing problem on Local...");
        ...
        if (!probRes.ok) {
            console.error("Local Backend Error:", probRes.status, await probRes.text());
            return;
        }
